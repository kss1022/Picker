...
protocol ResizeControlDelegate: AnyObject {
    func didBean(_ control: CropResizeControl)    //Began
    func didChange(_ control: CropResizeControl)   //Change
    func didEndEditing(_ control: CropResizeControl)  //End , Called
}


class CropResizeControl: UIView {
